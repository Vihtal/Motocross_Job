Locales['fr'] = {
  ...
  ['billing']                   = 'Facture',
  ['invoice_amount']            = 'Montant Factures',
  ...
  --Vehicles
    ...
    ['vehicle_out'] = 'Il y a déjà un véhicule dans la zone',
    ['vehicle_spawner'] = 'Appuyer sur ~INPUT_CONTEXT~ pour sortir un véhicule',
    ['store_vehicle'] = 'Appuyer sur ~INPUT_CONTEXT~ pour ranger le véhicule',
  --Action Menu
    ['citizen_interaction'] = 'Interaction Civil',
    ['vehicle_interaction'] = 'Interaction Véhicule',
    ['citizen_billing'] = 'Facturation',

    ['id_card'] = 'Carte Identité',
    ['search'] = 'Rechercher',
    ['handcuff'] = 'Menotter / Démenotter',
    ['put_in_vehicle'] = 'Mettre dans un véhicule',
    ['vehicle_out'] = 'Sortir du véhicule',
    ['out_the_vehicle'] = 'Sortir du véhicule',
    ['no_players_nearby'] = '~r~Aucun joueur à proximité',
    ['pick_lock'] = 'Voler le véhicule',
    ['vehicle_unlocked'] = 'Véhicule ~g~ouvert~s~',
    ['no_vehicles_nearby'] = '~r~Aucun véhicule à proximité',
  ...
  --ID Card Menu
    ...
    ['bac'] = 'DNI : ',
  --Body Search Menu
    ['confiscate_dirty'] = 'Prendre argent sale: $',
    ['guns_label'] = '--- Armes ---',
    ['confiscate'] = 'Prendre ',
    ['inventory_label'] = '--- Inventaire ---',
    ['confiscate_inv'] = 'Récupérer x',

  --Notifications
    ['from'] = '~s~ de ~b~',
    ['you_have_confinv'] = 'Vous avez pris ~y~x',
    ['confinv'] = '~s~ vous à étais pris ~y~x',
    ['you_have_confdm'] = 'Vous avez pris  ~y~$',
    ['confdm'] = '~s~ vous à étais pris ~y~$',
    ['you_have_confweapon'] = 'Vous avez pris ~y~x1 ',
    ['confweapon'] = '~s~ vous à étais pris ~y~x1 ',
}
